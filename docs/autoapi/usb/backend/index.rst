...
.. py:class:: IBackend
   ...
   .. py:method:: enumerate_devices(self)
   ...
   .. py:method:: get_parent(self, dev)

      Return the parent device of the given device.


   .. py:method:: get_device_descriptor(self, dev)
   ...
   .. py:method:: get_configuration_descriptor(self, dev, config)
   ...
   .. py:method:: get_interface_descriptor(self, dev, intf, alt, config)
   ...
   .. py:method:: get_endpoint_descriptor(self, dev, ep, intf, alt, config)
   ...
   .. py:method:: open_device(self, dev)
   ...
   .. py:method:: close_device(self, dev_handle)
   ...
   .. py:method:: set_configuration(self, dev_handle, config_value)
   ...
   .. py:method:: get_configuration(self, dev_handle)
   ...
   .. py:method:: set_interface_altsetting(self, dev_handle, intf, altsetting)
   ...
   .. py:method:: claim_interface(self, dev_handle, intf)
   ...
   .. py:method:: release_interface(self, dev_handle, intf)
   ...
   .. py:method:: bulk_write(self, dev_handle, ep, intf, data, timeout)
   ...
   .. py:method:: bulk_read(self, dev_handle, ep, intf, buff, timeout)
   ...
   .. py:method:: intr_write(self, dev_handle, ep, intf, data, timeout)
   ...
   .. py:method:: iso_write(self, dev_handle, ep, intf, data, timeout)
   ...
   .. py:method:: iso_read(self, dev_handle, ep, intf, size, timeout)
   ...
   .. py:method:: ctrl_transfer(self, dev_handle, bmRequestType, bRequest, wValue, wIndex, data, timeout)
   ...
   .. py:method:: clear_halt(self, dev_handle, ep)

      Clear the halt/stall condition for the endpoint.


   .. py:method:: reset_device(self, dev_handle)

      Reset the device.


   .. py:method:: is_kernel_driver_active(self, dev_handle, intf)
   ...
   .. py:method:: detach_kernel_driver(self, dev_handle, intf)
   ...
   .. py:method:: attach_kernel_driver(self, dev_handle, intf)
